...
#󰕈
# Prompt setup
PS1="%B%F${COLOR_MAGENTA}%n@%m%f%b %B%F${COLOR_RED}%~%f%b%${vcs_info_msg_0_} %B%F${COLOR_GREY}[0]%f%b%"
...
function update_prompt() {
    ...
    export PS1="%B%F${COLOR_MAGENTA}%n@%m%f%b %B%F${COLOR_RED}%~%f%b${vcs_info_msg_0_} %B${LAST_COMMAND_INDICATOR}%f%b"
}
...
function zle-keymap-select() {
    ...
    export PS1="%B%F${COLOR_MAGENTA}%n@%m%f%%B%F${COLOR_RED}%~%f%b${vcs_info_msg_0_} %B${LAST_COMMAND_INDICATOR}%b"
